...
TOKEN = '8164283211:AAGjM9H6Ho7IpuvFZHJrT60uxKY8dFhimlI'
...
def handle_attack_command(message):
    ...
    try:
        ...
        bot.send_message(chat_id, "*💣 Ready to launch an /bgmi?*\n"  # Ready to launch message
...
ial for improving our service and enhancing your experience.\n\n"
        "🌟 **Thank you for being a part of our community!** Your support means the world to us, and we’re always here to help!*\n"
    )
    bot.send_message(message.chat.id, response, parse_mode='Markdown')
